...
import ac.za.cput.cardealership.repositories.people.impl.AddressRepositoryImpl;
...
public class AddressServiceImplTest {
    ...
    private AddressServiceImpl repository;
    private Address address;

    @Before
    public void setUp() throws Exception {

        this.repository= (AddressServiceImpl) AddressServiceImpl.getRepository();
